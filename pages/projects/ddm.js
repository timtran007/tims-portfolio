...
import marketingImg from '../../public/images/projects/decisive-digital-marketing.png'
import { RiRadioButtonFill } from 'react-icons/ri';
import Link from 'next/link'

function DecisiveDigitalMarketing() {
  return (
      ...
      <div className='w-screen h-[50vh] '>
        ...
        <div className='absolute top-[40%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white -z-10 p-2'>
          <h2 className='py-2'>Decisive Digital Marketing</h2>
          <h3>WordPress / Elementor / Hostgator</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-5 grid md:grid-cols-5 gap-8 py-20'>
        <div className='col-span-4'>
          ...
          <a
            href='https://decisivedigitalmarketing.com/'
            target='_blank'
            rel='noreferrer'
            >
        ...
        <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4'>
          <div className='p-2'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1'>
              ...
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1' /> Hostgator
              </p>
            </div>
          </div>
        </div>
...
export default DecisiveDigitalMarketing